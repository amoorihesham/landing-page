...
const BrifSection = () => {
  return (
    <section className="py-10">
        ...
        <h2 className="text-white text-8xl font-bold">Maximize Sales in Egypt, Saudi, UAE Through arqqa Digital Marketing Agency</h2>
        ...
        <div className="stats flex items-center ms-auto flex-wrap justify-evenly mt-16">
